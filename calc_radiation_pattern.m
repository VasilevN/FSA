...
% TODO: make description of input arguments
...
function RP_o = calc_radiation_pattern( ...
    ...
    for x_i = 1:size_x
        ...
        for y_i = 1:size_y
            ...
            RP(y_i, x_i) = calc_dot( x_m, y_m, zone_number, lambda_m, focus_dist_m, rho_min_m, rho_max_m, phi_step_rad, rho_step_m, phi_cnt, rho_cnt, gamma_rad);
        end
    end
    RP_o = RP;
end
